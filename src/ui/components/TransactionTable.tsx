        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
          ...
          <div className={`${enableDateFilter ? 'opacity-100' : 'opacity-40 pointer-events-none'} transition-opacity flex flex-col`}>
            ...
            <DateInput
              ...
              className="px-2 py-1.5 border border-slate-300 rounded-lg text-xs outline-none bg-white focus:ring-2 focus:ring-indigo-500 flex items-center justify-between"
            />
          </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <DateInput
                    ...
                    onChange={(v) => setEditForm(prev => prev ? { ...prev, paymentDate: v } : null)}
                    required
